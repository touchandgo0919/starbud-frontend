...
const eventLabels: Record<string, string> = {
  ...
  submission_searched: "搜索提交", submission_audio_uploaded: "上传录音", submission_audio_reviewed: "评价录音", submission_submitted: "提交作业", submission_reopened: "退回重交", submission_deleted: "删除提交",
